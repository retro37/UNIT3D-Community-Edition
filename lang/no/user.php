 ...
 */
    ...
    'invites-rules' => [
        'Invitere kun folk du kjenner og stoler på.',
        'Du vil bli holdt personlig ansvarlig for de du inviterer.',
        'Ikke inviter deg selv, vi sjekker hver inviterte bruker.',
        'Ikke under noen omstendigheter selger du invitasjoner.',
        'Hvis en person du inviterte blir avslørt som kjøpt og betalt for, vil du bli sanksjonert.',
    ],
