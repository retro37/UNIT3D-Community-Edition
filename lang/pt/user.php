 ...
 */
    ...
    'invites-rules' => [
        'Apenas convide pessoas que você conhece e confia.',
        'Você será pessoalmente responsável por aqueles que convidar.',
        'Não se convide, nós verificamos cada usuário convidado.',
        'Não negocie ou venda convites.',
        'Se uma pessoa que você convidou for pega batota, conta de negociação ou venda / troca de convites, você será avisado.',
    ],
