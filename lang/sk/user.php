 ...
 */
    ...
    'invites-rules' => [
        'Pozývajte len ľudí, ktorých poznáte a ktorým dôverujete.',
        'Budete osobne zodpovední za tých, ktorých pozvete.',
        'Nepozývajte sa, kontrolujeme každého pozvaného používateľa.',
        'Dont obchod alebo predaj Pozvánky.',
        'Ak osoba, ktorú ste pozvali, je chytená podvádzaním, obchodným účtom alebo predajom / obchodovaním, budete upozornení.',
    ],
